...
# Experiment with sample function
sample(1:10, replace = TRUE)

# Re create the combi data frame
test$Survived <- NA
...
# Clean embarked and fare columns
...
# Reduce the number of levels in FamilyID2
combi$FamilyID2 <- combi$FamilyID
combi$FamilyID2 <- as.character(combi$FamilyID2)
combi$FamilyID2[combi$FamilySize <= 3] <- 'Small'
combi$FamilyID2 <- factor(combi$FamilyID2)

# Create and grow the random forest
